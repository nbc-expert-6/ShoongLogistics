...
public final class HubMapper {
	...
	//실제 로직
	public static List<CreateDeliveryRoutesInfo> toCreateDeliveryRoutesInfo(List<FeignHubResponse> data) {

		return data.stream()
			.map(r -> new CreateDeliveryRoutesInfo(
				r.departureHubId(),
				r.arrivalHubId(),
				r.sequence(),
				r.estimateDistance(),
	...
	//더미 응답
	public static List<CreateDeliveryRoutesInfo> toCreateDeliveryRoutesInfoDummy() {
		return List.of(
			CreateDeliveryRoutesInfo.from(
